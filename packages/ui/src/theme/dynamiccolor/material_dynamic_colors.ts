...
export class MaterialDynamicColors {
  ...
  static onBackground = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.background,
  });
  ...
  static onSurfaceVariant = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.surfaceVariant,
  });
  ...
  static inverseOnSurface = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.inverseSurface,
  });
  ...
  static onPrimary = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.primary,
  });
  ...
  static onPrimaryContainer = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.primaryContainer,
  });
  ...
  static inverseOnPrimary = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.inversePrimary,
  });
  ...
  static onSecondary = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.secondary,
  });
  ...
  static onSecondaryContainer = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.secondaryContainer,
  });
  ...
  static onTertiary = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.tertiary,
  });
  ...
  static onTertiaryContainer = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.tertiaryContainer,
  });
  ...
  static onError = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.error,
  });
  ...
  static onErrorContainer = DynamicColor.fromPalette({
    palette: (s) => s.errorPalette,
    tone: (s) => s.isDark ? 90 : 10,
    background: (_s) => MaterialDynamicColors.errorContainer,
  });
  ...
  static onPrimaryFixed = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.primaryFixedDim,
  });
  ...
  static onSecondaryFixed = DynamicColor.fromPalette({
    palette: (s) => s.secondaryPalette,
    tone: (_s) => 10.0,
    background: (_s) => MaterialDynamicColors.secondaryFixedDim,
  });
  ...
  static onTertiaryFixed = DynamicColor.fromPalette({
    ...
    background: (_s) => MaterialDynamicColors.tertiaryFixedDim,
  });
