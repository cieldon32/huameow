...
export type Variant = 'filled' | 'elevated' | 'tonal' | 'outlined' | 'transparent';

export type Position = 'top-right' | 'bottom-right' | 'top-left' | 'bottom-left' | 'top-center' | 'bottom-center' | 'center' | 'top' | 'bottom' | 'left' | 'right';
